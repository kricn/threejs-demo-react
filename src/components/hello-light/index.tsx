...
const buttonLables = [
  LightType.AmbientLight, LightType.AmbientLightProbe, LightType.DirectionalLight,
  ...
  useEffect(() => {
    ...
    switch (type) {
      ...
      case LightType.AmbientLightProbe:
        const ambientLightProbe = new Three.AmbientLight(0xffffff, 1);
      ...
      case LightType.HemisphereLightProbe:
        const hemisphereLightProbe = new Three.HemisphereLight(
          0xb1e1ff,
          0xb97a20,
          1
        );
